...
approaches::
    ...
    python -m testatron.run
    python path/to/testatron/run.py
...
Usage:  testatron [options] data_sources
...
# Simple test run with `testatron` without options.
$ testatron tests.html

"""

import sys

# if 'testatron' not in sys.modules and __name__ == '__main__':
    import pythonpathsetter

# from testatron.conf import RobotSettings
# from testatron.output import LOGGER
...
def run(*datasources, **options):
    ...
    `testatron` command from the command line. Options are given as keyword
    ...
    Equivalent command line usage::
        ...
        testatron --include tag1 --include tag2 path/to/tests.html
        testatron --report r.html --log NONE t1.txt t2.txt > stdout.txt
    """
