...
# from jataayu.errors import (INFO_PRINTED, DATA_ERROR, STOPPED_BY_USER,
...
class Application(object):
    ...
    def __init__(self, usage, name=None,  **auto_options):
    ...
    def parse_arguments(self, cli_args):
        ...
        :raises:  :class:`~jataayu.errors.Information` when --help or --version used
        :raises:  :class:`~jataayu.errors.DataError` when parsing fails
        """
