...
#     try:
#         from testatron.application import Jataayu
#     except ImportError:
#         raise
#     if inpath:
#         inpath = unicode(inpath, sys.getfilesystemencoding())
#     testatron = Jataayu(inpath, updatecheck)
#     if debug_console:
#         _start_debug_console(testatron)
#     testatron.MainLoop()
#
#
# def _print_stacks():
...
#
# def _start_debug_console(testatron):
#     import code
#     help_string = """\
# Jataayu - access to the running application
# print_stacks() - print current stack traces
# """
#     console = code.InteractiveConsole(locals={'Jataayu':testatron, 'print_stacks':_print_stacks})
